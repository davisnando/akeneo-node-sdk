...
/**
 * Check if a given object implements the PatchFamiliesFamilyCodeVariantsRequest interface.
 */
export function instanceOfPatchFamiliesFamilyCodeVariantsRequest(value: object): boolean {
    let isInstance = true;
...
export function PatchFamiliesFamilyCodeVariantsRequestFromJSON(json: any): PatchFamiliesFamilyCodeVariantsRequest {
    return PatchFamiliesFamilyCodeVariantsRequestFromJSONTyped(json, false);
}

export function PatchFamiliesFamilyCodeVariantsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PatchFamiliesFamilyCodeVariantsRequest {
...
export function PatchFamiliesFamilyCodeVariantsRequestToJSON(value?: PatchFamiliesFamilyCodeVariantsRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
