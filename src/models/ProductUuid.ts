...
/**
 * Check if a given object implements the ProductUuid interface.
 */
export function instanceOfProductUuid(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ProductUuidFromJSON(json: any): ProductUuid {
    return ProductUuidFromJSONTyped(json, false);
}

export function ProductUuidFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductUuid {
...
export function ProductUuidToJSON(value?: ProductUuid | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
