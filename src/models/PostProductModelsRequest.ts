...
/**
 * Check if a given object implements the PostProductModelsRequest interface.
 */
export function instanceOfPostProductModelsRequest(value: object): boolean {
    let isInstance = true;
...
export function PostProductModelsRequestFromJSON(json: any): PostProductModelsRequest {
    return PostProductModelsRequestFromJSONTyped(json, false);
}

export function PostProductModelsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostProductModelsRequest {
...
export function PostProductModelsRequestToJSON(value?: PostProductModelsRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
