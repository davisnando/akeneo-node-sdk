...
/**
 * Check if a given object implements the GetProductsCode200Response interface.
 */
export function instanceOfGetProductsCode200Response(value: object): boolean {
    let isInstance = true;
...
export function GetProductsCode200ResponseFromJSON(json: any): GetProductsCode200Response {
    return GetProductsCode200ResponseFromJSONTyped(json, false);
}

export function GetProductsCode200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetProductsCode200Response {
...
export function GetProductsCode200ResponseToJSON(value?: GetProductsCode200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
