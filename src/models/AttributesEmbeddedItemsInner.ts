 ...
 * 
 * @export
 * @interface AttributesEmbeddedItemsInner
 */
export interface AttributesEmbeddedItemsInner {
    /**
     * 
     * @type {ProductsEmbeddedItemsInnerAllOfLinks}
     * @memberof AttributesEmbeddedItemsInner
     */
     ...
     * @memberof AttributesEmbeddedItemsInner
     */
    type: AttributesEmbeddedItemsInnerTypeEnum;
    /**
     * 
 ...
 * @export
 */
export const AttributesEmbeddedItemsInnerTypeEnum = {
...
export type AttributesEmbeddedItemsInnerTypeEnum = typeof AttributesEmbeddedItemsInnerTypeEnum[keyof typeof AttributesEmbeddedItemsInnerTypeEnum];


/**
 * Check if a given object implements the AttributesEmbeddedItemsInner interface.
 */
export function instanceOfAttributesEmbeddedItemsInner(value: object): boolean {
    let isInstance = true;
...
export function AttributesEmbeddedItemsInnerFromJSON(json: any): AttributesEmbeddedItemsInner {
    return AttributesEmbeddedItemsInnerFromJSONTyped(json, false);
}

export function AttributesEmbeddedItemsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): AttributesEmbeddedItemsInner {
...
export function AttributesEmbeddedItemsInnerToJSON(value?: AttributesEmbeddedItemsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
