...
/**
 * Check if a given object implements the PatchProductsRequest interface.
 */
export function instanceOfPatchProductsRequest(value: object): boolean {
    let isInstance = true;
...
export function PatchProductsRequestFromJSON(json: any): PatchProductsRequest {
    return PatchProductsRequestFromJSONTyped(json, false);
}

export function PatchProductsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PatchProductsRequest {
...
export function PatchProductsRequestToJSON(value?: PatchProductsRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
