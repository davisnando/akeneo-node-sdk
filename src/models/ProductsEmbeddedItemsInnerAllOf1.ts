 ...
 * 
 * @export
 * @interface ProductsEmbeddedItemsInnerAllOf1
 */
export interface ProductsEmbeddedItemsInnerAllOf1 {
    /**
     * Product UUID
     * @type {string}
     * @memberof ProductsEmbeddedItemsInnerAllOf1
     */
    uuid?: string;
    /**
...
/**
 * Check if a given object implements the ProductsEmbeddedItemsInnerAllOf1 interface.
 */
export function instanceOfProductsEmbeddedItemsInnerAllOf1(value: object): boolean {
    let isInstance = true;
...
export function ProductsEmbeddedItemsInnerAllOf1FromJSON(json: any): ProductsEmbeddedItemsInnerAllOf1 {
    return ProductsEmbeddedItemsInnerAllOf1FromJSONTyped(json, false);
}

export function ProductsEmbeddedItemsInnerAllOf1FromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductsEmbeddedItemsInnerAllOf1 {
...
export function ProductsEmbeddedItemsInnerAllOf1ToJSON(value?: ProductsEmbeddedItemsInnerAllOf1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
