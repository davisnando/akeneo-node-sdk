...
/**
 * Check if a given object implements the AttributeListAllOf interface.
 */
export function instanceOfAttributeListAllOf(value: object): boolean {
    let isInstance = true;
...
export function AttributeListAllOfFromJSON(json: any): AttributeListAllOf {
    return AttributeListAllOfFromJSONTyped(json, false);
}

export function AttributeListAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): AttributeListAllOf {
...
export function AttributeListAllOfToJSON(value?: AttributeListAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
