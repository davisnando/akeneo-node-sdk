...
/**
 * Check if a given object implements the PostAttributesRequest interface.
 */
export function instanceOfPostAttributesRequest(value: object): boolean {
    let isInstance = true;
...
export function PostAttributesRequestFromJSON(json: any): PostAttributesRequest {
    return PostAttributesRequestFromJSONTyped(json, false);
}

export function PostAttributesRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostAttributesRequest {
...
export function PostAttributesRequestToJSON(value?: PostAttributesRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
