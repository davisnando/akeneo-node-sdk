 ...
 * 
 * @export
 * @interface AttributesEmbeddedItemsInnerAllOf
 */
export interface AttributesEmbeddedItemsInnerAllOf {
    /**
     * Attribute code
     * @type {string}
     * @memberof AttributesEmbeddedItemsInnerAllOf
     */
    code: string;
    /**
     ...
     * @memberof AttributesEmbeddedItemsInnerAllOf
     */
    type: AttributesEmbeddedItemsInnerAllOfTypeEnum;
    /**
     * 
 ...
 * @export
 */
export const AttributesEmbeddedItemsInnerAllOfTypeEnum = {
...
export type AttributesEmbeddedItemsInnerAllOfTypeEnum = typeof AttributesEmbeddedItemsInnerAllOfTypeEnum[keyof typeof AttributesEmbeddedItemsInnerAllOfTypeEnum];


/**
 * Check if a given object implements the AttributesEmbeddedItemsInnerAllOf interface.
 */
export function instanceOfAttributesEmbeddedItemsInnerAllOf(value: object): boolean {
    let isInstance = true;
...
export function AttributesEmbeddedItemsInnerAllOfFromJSON(json: any): AttributesEmbeddedItemsInnerAllOf {
    return AttributesEmbeddedItemsInnerAllOfFromJSONTyped(json, false);
}

export function AttributesEmbeddedItemsInnerAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): AttributesEmbeddedItemsInnerAllOf {
...
export function AttributesEmbeddedItemsInnerAllOfToJSON(value?: AttributesEmbeddedItemsInnerAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
