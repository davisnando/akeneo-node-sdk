 ...
 * 
 * @export
 * @interface ProductsEmbeddedItemsInner
 */
export interface ProductsEmbeddedItemsInner {
    /**
     * 
...
/**
 * Check if a given object implements the ProductsEmbeddedItemsInner interface.
 */
export function instanceOfProductsEmbeddedItemsInner(value: object): boolean {
    let isInstance = true;
...
export function ProductsEmbeddedItemsInnerFromJSON(json: any): ProductsEmbeddedItemsInner {
    return ProductsEmbeddedItemsInnerFromJSONTyped(json, false);
}

export function ProductsEmbeddedItemsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductsEmbeddedItemsInner {
...
export function ProductsEmbeddedItemsInnerToJSON(value?: ProductsEmbeddedItemsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
