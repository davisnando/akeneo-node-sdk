 ...
 * 
 * @export
 * @interface PublishedProductsEmbeddedItemsInnerAllOf
 */
export interface PublishedProductsEmbeddedItemsInnerAllOf {
    /**
     * Published product identifier, i.e. the value of the only `pim_catalog_identifier` attribute
     * @type {string}
     * @memberof PublishedProductsEmbeddedItemsInnerAllOf
     */
    identifier: string;
    /**
...
/**
 * Check if a given object implements the PublishedProductsEmbeddedItemsInnerAllOf interface.
 */
export function instanceOfPublishedProductsEmbeddedItemsInnerAllOf(value: object): boolean {
    let isInstance = true;
...
export function PublishedProductsEmbeddedItemsInnerAllOfFromJSON(json: any): PublishedProductsEmbeddedItemsInnerAllOf {
    return PublishedProductsEmbeddedItemsInnerAllOfFromJSONTyped(json, false);
}

export function PublishedProductsEmbeddedItemsInnerAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublishedProductsEmbeddedItemsInnerAllOf {
...
export function PublishedProductsEmbeddedItemsInnerAllOfToJSON(value?: PublishedProductsEmbeddedItemsInnerAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
