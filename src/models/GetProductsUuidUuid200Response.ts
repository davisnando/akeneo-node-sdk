...
/**
 * Check if a given object implements the GetProductsUuidUuid200Response interface.
 */
export function instanceOfGetProductsUuidUuid200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function GetProductsUuidUuid200ResponseFromJSON(json: any): GetProductsUuidUuid200Response {
    return GetProductsUuidUuid200ResponseFromJSONTyped(json, false);
}

export function GetProductsUuidUuid200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetProductsUuidUuid200Response {
...
export function GetProductsUuidUuid200ResponseToJSON(value?: GetProductsUuidUuid200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
