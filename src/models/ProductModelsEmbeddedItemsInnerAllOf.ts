 ...
 * 
 * @export
 * @interface ProductModelsEmbeddedItemsInnerAllOf
 */
export interface ProductModelsEmbeddedItemsInnerAllOf {
    /**
     * Product model code
     * @type {string}
     * @memberof ProductModelsEmbeddedItemsInnerAllOf
     */
    code: string;
    /**
...
/**
 * Check if a given object implements the ProductModelsEmbeddedItemsInnerAllOf interface.
 */
export function instanceOfProductModelsEmbeddedItemsInnerAllOf(value: object): boolean {
    let isInstance = true;
...
export function ProductModelsEmbeddedItemsInnerAllOfFromJSON(json: any): ProductModelsEmbeddedItemsInnerAllOf {
    return ProductModelsEmbeddedItemsInnerAllOfFromJSONTyped(json, false);
}

export function ProductModelsEmbeddedItemsInnerAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductModelsEmbeddedItemsInnerAllOf {
...
export function ProductModelsEmbeddedItemsInnerAllOfToJSON(value?: ProductModelsEmbeddedItemsInnerAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
