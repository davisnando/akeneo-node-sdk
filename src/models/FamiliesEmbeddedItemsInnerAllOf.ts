 ...
 * 
 * @export
 * @interface FamiliesEmbeddedItemsInnerAllOf
 */
export interface FamiliesEmbeddedItemsInnerAllOf {
    /**
     * Family code
     * @type {string}
     * @memberof FamiliesEmbeddedItemsInnerAllOf
     */
    code: string;
    /**
...
/**
 * Check if a given object implements the FamiliesEmbeddedItemsInnerAllOf interface.
 */
export function instanceOfFamiliesEmbeddedItemsInnerAllOf(value: object): boolean {
    let isInstance = true;
...
export function FamiliesEmbeddedItemsInnerAllOfFromJSON(json: any): FamiliesEmbeddedItemsInnerAllOf {
    return FamiliesEmbeddedItemsInnerAllOfFromJSONTyped(json, false);
}

export function FamiliesEmbeddedItemsInnerAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): FamiliesEmbeddedItemsInnerAllOf {
...
export function FamiliesEmbeddedItemsInnerAllOfToJSON(value?: FamiliesEmbeddedItemsInnerAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
