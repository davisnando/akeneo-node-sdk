...
/**
 * Check if a given object implements the ProductListAllOf1QuantifiedAssociationsQuantifiedAssociationTypeCode interface.
 */
export function instanceOfProductListAllOf1QuantifiedAssociationsQuantifiedAssociationTypeCode(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ProductListAllOf1QuantifiedAssociationsQuantifiedAssociationTypeCodeFromJSON(json: any): ProductListAllOf1QuantifiedAssociationsQuantifiedAssociationTypeCode {
    return ProductListAllOf1QuantifiedAssociationsQuantifiedAssociationTypeCodeFromJSONTyped(json, false);
}

export function ProductListAllOf1QuantifiedAssociationsQuantifiedAssociationTypeCodeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductListAllOf1QuantifiedAssociationsQuantifiedAssociationTypeCode {
...
export function ProductListAllOf1QuantifiedAssociationsQuantifiedAssociationTypeCodeToJSON(value?: ProductListAllOf1QuantifiedAssociationsQuantifiedAssociationTypeCode | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
