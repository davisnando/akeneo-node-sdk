 ...
 * 
 * @export
 * @interface ProductModelsEmbeddedItemsInner
 */
export interface ProductModelsEmbeddedItemsInner {
    /**
     * 
     * @type {ProductsEmbeddedItemsInnerAllOfLinks}
     * @memberof ProductModelsEmbeddedItemsInner
     */
...
/**
 * Check if a given object implements the ProductModelsEmbeddedItemsInner interface.
 */
export function instanceOfProductModelsEmbeddedItemsInner(value: object): boolean {
    let isInstance = true;
...
export function ProductModelsEmbeddedItemsInnerFromJSON(json: any): ProductModelsEmbeddedItemsInner {
    return ProductModelsEmbeddedItemsInnerFromJSONTyped(json, false);
}

export function ProductModelsEmbeddedItemsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductModelsEmbeddedItemsInner {
...
export function ProductModelsEmbeddedItemsInnerToJSON(value?: ProductModelsEmbeddedItemsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
