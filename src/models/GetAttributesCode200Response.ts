...
/**
 * Check if a given object implements the GetAttributesCode200Response interface.
 */
export function instanceOfGetAttributesCode200Response(value: object): boolean {
    let isInstance = true;
...
export function GetAttributesCode200ResponseFromJSON(json: any): GetAttributesCode200Response {
    return GetAttributesCode200ResponseFromJSONTyped(json, false);
}

export function GetAttributesCode200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetAttributesCode200Response {
...
export function GetAttributesCode200ResponseToJSON(value?: GetAttributesCode200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
