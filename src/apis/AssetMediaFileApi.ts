...
export class AssetMediaFileApi extends runtime.BaseAPI {
   ...
   */
  async getAssetMediaFilesCodeRaw(
    requestParameters: GetAssetMediaFilesCodeRequest,
    ...
    if (
      ...
      throw new runtime.RequiredError(
        "code",
        "Required parameter requestParameters.code was null or undefined when calling getAssetMediaFilesCode."
      );
    }
    ...
    const response = await this.request(
      {
        path: `/api/rest/v1/asset-media-files/{code}`.replace(
          `{${"code"}}`,
   ...
   */
  async postAssetMediaFilesRaw(
    requestParameters: PostAssetMediaFilesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (
      ...
      throw new runtime.RequiredError(
        "contentType",
        "Required parameter requestParameters.contentType was null or undefined when calling postAssetMediaFiles."
      );
    }
